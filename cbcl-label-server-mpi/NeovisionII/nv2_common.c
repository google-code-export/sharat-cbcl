...
// $HeadURL: svn://iLab.usc.edu/trunk/saliency/src/NeovisionII/nv2_common.c $
// $Id: nv2_common.c 9352 2007-08-04 05:00:33Z rjpeters $
//
...
void nv2_fatal(const char* what)
{
        if (errno != 0)
