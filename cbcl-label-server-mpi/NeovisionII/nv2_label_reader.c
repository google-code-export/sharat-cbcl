...
// $HeadURL: svn://iLab.usc.edu/trunk/saliency/src/NeovisionII/nv2_label_reader.c $
// $Id: nv2_label_reader.c 9352 2007-08-04 05:00:33Z rjpeters $
//
...
static void* run_label_reader(void* q)
{
        ...
        pthread_cleanup_push(&cleanup_fd, &socket_fd);
